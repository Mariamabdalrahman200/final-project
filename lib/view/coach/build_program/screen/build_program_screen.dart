      ...
      return ResponsiveConfig.setupResponsiveWrapper(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    if (!isEditMode)
                      Text(
                        ...
                        style: TextStyle(
                       fontSize: isPortrait ? 19.sp : 15.sp,
                  ...
                  SizedBox(height: isPortrait ? 20.h : 10.h),
                    ...
                    SizedBox(height: isPortrait ? 30.h : 15.h),
                    Text(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return GestureDetector(
                            ...
                            child: Container(
                              ...
                              padding:
                                  EdgeInsets.symmetric( horizontal: isPortrait ? 12.w : 10.w,
                                  vertical: isPortrait ? 8.h : 6.h,),
                              decoration: BoxDecoration(
        ...
        Positioned(
          ...
          child: CustomButton(
            ...
            onTap: () {
              if (isEditMode) {
               controller.updateProgram(programId:existingProgram!.id);
              } else {
                controller.makeProgram(traineeId: user.id);
              }
            },
          ),
        ),  if (controller.isLoadingSend) const CircularProgressIndicatorCustom(),
          ]   
           ),
